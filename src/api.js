...
const API_BASE_URL = "https://spotify-recommender-backend-production.up.railway.app"; // FastAPI backend

export const fetchClusterPlot = async () => {
    try {
        const plotResponse = await axios.get("https://spotify-recommender-backend-production.up.railway.app/plot_clusters");
